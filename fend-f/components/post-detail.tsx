...
import { ArrowLeft, Mail, Phone, MapPin, Share2, Facebook, X, LinkIcon, Check } from "lucide-react"
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="contacts" className="border-[#BFDBFE]">
                ...
                <AccordionContent className="space-y-3 pt-4">
                  <a
                    href="mailto:contact@futureleadersassembly.org"
                ...
                <AccordionContent className="pt-4">
                  <div className="flex gap-3">
                    ...
                    <Button
                      ...
                      className="bg-black hover:bg-black/90 text-white rounded-lg transition-all duration-200 hover:scale-105"
                    >
